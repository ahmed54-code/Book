	...
	<main class="main-content">
		...
		<div class="item">
			@if($slider->media_img == 'No image found')
                <img src="/assets/images/no-image.jpg" width="100%" height="516" alt="No image found">
            @else
                <img src="/uploads/{{ $slider->media_img }}" width="100%" height="516" alt="{{ $slider->title }}">
            @endif
		</div>
		<!-- Item -->
		@empty
							...
							<div class="item">
								...
								<div class="detail-img">
									@if($upcoming_book->book_img == 'No image found')
                                        <img src="/assets/images/no-image.jpg" width="112" height="156" alt="No image found">
                                    @else
						...
						<ul id="release-thumb" class="release-thumb">
							...
							<li>
								<a data-slide-index="{{$key}}" href="{{ route('book.show', [$upcoming_book->slug]) }}">
									...
									@if($upcoming_book->book_img == 'No image found')
                                        <img src="/assets/images/no-image.jpg" width="94" height="122" alt="No image found">
                                    @else
			    				...
			    				<div class="product-box">
			    					<div class="product-img">
			    						@if($downloaded_book->book_img == 'No image found')
                                            <img src="/assets/images/no-image.jpg" width="132" height="197" alt="No image found">
                                        @else
			    					...
			    					<div class="product-detail">
			    						...
			    						<div class="aurthor-detail">
			    							<span><img src="/assets/images/book-aurthor/img-01.jpg" alt="">{{ $downloaded_book->author_book->title }}</span>
			    						</div>
			    					</div>
			    				</div>
			    			</div>
				...
				<div class="recomend-slider">
					...
					<div class="item">
						@if($recomended_book->book_img == 'No image found')
                            <img src="/assets/images/no-image.jpg" width="109" height="150" alt="No image found">
                        @else
											...
											<div class="s-product">
												<div class="s-product-img">
													 @if($book->book_img == 'No image found')
                                                        <img src="/assets/images/no-image.jpg" width="145" height="209" alt="No image found">
                                                    @else
												...
												<span>{{ $book->author_book->title }}</span>
											</div>
										</li>
										@empty
                                            <div class="alert alert-danger">No record found!</div>
					...
					<div class="col-lg-3 col-sm-12">
						<div class="aurthor-img">
							@if($author_feature->author_img == 'No image found')
                                <img src="/assets/images/no-image.jpg" width="243" height="344" alt="No image found">
                            @else
						...
						<div id="timeline">
							<ul id="issues">
								<li id="1985">
									<div class="text-box">
										<div class="left-box">
											<h5><span class="theme-color">{{ $author_feature->title }}</span> Books Writer</h5>
										...
										<ul class="s-related-products">
											@foreach($author_feature->book as $key => $author_book)
                                            @if($key < 3)
                                            <li>
                                                @if($author_book->book_img == 'No image found')
                                                    <img src="/assets/images/no-image.jpg" width="89" height="119" alt="No image found">
                                                @else
			                ...
			                <li>
			                  	<div class="gallery-figure"> 
			                  		@if($gallery->media_img == 'No image found')
                                        <img src="/assets/images/no-image.jpg" width="242" height="187" alt="No image found">
                                    @else
